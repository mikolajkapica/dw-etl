...
# Import operation functions (we'll reuse the logic)
from himalayan_etl.ops.extraction import (
    extract_expeditions_csv as _extract_expeditions_csv,
    extract_members_csv as _extract_members_csv,
    extract_peaks_csv as _extract_peaks_csv,
    extract_references_csv as _extract_references_csv
)
...
raw_data_assets = AssetGroup(
    [raw_expeditions, raw_members, raw_peaks, raw_world_bank_data],
    resource_defs={
        "fs": FileSystemResource,
        "etl_config": ETLConfigResource
    }
...
processed_data_assets = AssetGroup(
    [cleaned_expeditions, cleaned_members, dim_date, dim_peak, dim_member, fact_expeditions],
    resource_defs={
        "db": DatabaseResource,
        "etl_config": ETLConfigResource
    }
